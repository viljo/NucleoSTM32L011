##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.17.1] date: [Mon Jul 18 14:42:31 CEST 2022]
##########################################################################################################################
...
# Flags
#######################################
OCDFLAGS   = -f board/stm32l0discovery.cfg
...
#######################################
# Openocd programmer debugger
#######################################
openocd:
	$(OCD) -s $(OCD_DIR) $(OCDFLAGS)

program: all
	openocd -s $(OCD_DIR) $(OCDFLAGS) -c "program $(BUILD_DIR)/$(TARGET).elf verify reset"
